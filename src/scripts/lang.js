...
const getLocaleStr = (key, fallbackLocale = 'enUS') => locale[key] ?? locales[fallbackLocale][key] ?? `Missing locale entry (${key}@${locale}|${fallbackLocale})! This is a bug, please report it!`;
