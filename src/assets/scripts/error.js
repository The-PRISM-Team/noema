...
window.addEventListener("error", (event) => {
    ...
    if (!started) {
        let errorSound = new Audio('/src/assets/sounds/menu/fatal-error.flac');
        let errorSound2 = new Audio('/src/assets/sounds/menu/fatal-error.flac');
        ...
        new Audio('/src/assets/sounds/menu/error.flac').play();
    }
    if (started) errors++;
